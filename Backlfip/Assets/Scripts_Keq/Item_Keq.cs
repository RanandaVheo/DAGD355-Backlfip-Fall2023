...
//============================================================================
//  This script is a copy of Item_Hank, but with changes to work in my scene
//============================================================================
public class Item_Keq : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            Player_Keq playerRef = collision.GetComponent<Player_Keq>();
            bool addedSuccessfully = playerRef.AddToInventory(gameObject);
